...
export function valueOrDefault(value: number | undefined, defaultValue: number) {
    return value === undefined ? defaultValue : value;
}

export function rand(min: number | undefined, max: number | undefined) {
